...
class dimension_converter {
  ...
  constexpr static float focus_length = 16.F; //milimeters
  ...
  constexpr static float half_camera_width = camera_width_resolution / 2.F; //pixels
  constexpr static float half_camera_height = camera_height_resolution / 2.F; //pixels

  float camera_distance_; //milimeters
